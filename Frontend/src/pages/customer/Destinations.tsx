        ...
        <aside className="space-y-6">
          <div className="rounded-2xl border border-slate-200 bg-white px-4 py-3 shadow-sm dark:border-slate-800 dark:bg-slate-900">
            <div className="flex items-center justify-between gap-4">
              <div>
                <h2 className="text-sm font-bold text-slate-900 dark:text-slate-100">Group Trip Mode</h2>
            ...
            <div className="space-y-7">
              <div>
                ...
                <input
                  ...
                  className="h-2 w-full cursor-pointer appearance-none rounded-lg bg-slate-100 accent-blue-600 dark:bg-slate-800"
                />
              ...
              <div>
                <h3 className="mb-3 text-sm font-semibold text-slate-700 dark:text-slate-200">Star Rating</h3>
                <div className="flex gap-2">
                  {[3, 4, 5].map((starCount) => (
                    <button
                      key={starCount}
                      type="button"
                      onClick={() => setSelectedStars((previous) => (previous === starCount ? null : starCount))}
                      className={`min-w-[42px] rounded-xl border px-3 py-1.5 text-xs font-bold transition-colors ${
              ...
              <div>
                ...
                <div className="space-y-2.5">
                  {areaOptions.map((area) => (
                    <label key={area} className="flex items-center gap-2.5 text-sm text-slate-600 dark:text-slate-300">
                      <input
                        type="checkbox"
              ...
              <div>
                <h3 className="mb-3 text-sm font-semibold text-slate-700 dark:text-slate-200">Amenities</h3>
                <div className="space-y-2.5">
                  {amenityOptions.map((amenity) => (
                    <label key={amenity} className="flex items-center gap-2.5 text-sm text-slate-600 dark:text-slate-300">
                      <input
                        type="checkbox"
              ...
              <button
                type="button"
                onClick={() => document.getElementById('destination-results')?.scrollIntoView({ behavior: 'smooth', block: 'start' })}
                className="mt-2 w-full rounded-xl bg-blue-100 px-4 py-3 text-sm font-semibold text-blue-600 transition-colors hover:bg-blue-200 dark:bg-blue-950/40 dark:text-blue-300"
              >
                Apply All Filters
              </button>
            </div>
