...
export const CustomerBookings = () => {
        ...
        const run = async () => {
            ...
            try {
                ...
                const mergedBookings = pendingBooking
                    ? [pendingBooking, ...apiBookings.filter((booking) => String(booking.id) !== String(pendingBooking.id))]
                    : apiBookings;
    ...
    return (<div className="px-4 sm:px-6 lg:px-8 pt-28 pb-20 max-w-6xl mx-auto">
