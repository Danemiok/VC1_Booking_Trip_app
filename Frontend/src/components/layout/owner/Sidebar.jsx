...
import { LayoutDashboard, MapPin, Bus, CalendarCheck, MessageSquare, Tag, BarChart3, Wallet, Settings, User } from 'lucide-react';
import { cn } from '@/utils/utils';
import { apiRequest } from '@/services/api';
import { messageService } from '@/services/messageService';
import { BrandLogo } from '@/components/common/BrandLogo';
const Sidebar = () => {
    const [destinationsCount, setDestinationsCount] = React.useState(null);
    ...
    return (<aside className="fixed inset-y-0 left-0 w-64 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 z-30 hidden lg:flex flex-col">
      <div className="p-6">
