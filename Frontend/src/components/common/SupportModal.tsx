                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3 p-4 bg-blue-50 rounded-xl border border-blue-100">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">support@tripbooking.com</p>
                    </div>
                  </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  <details className="border border-gray-200 rounded-xl p-4 bg-white">
                    <summary className="font-medium text-gray-900 cursor-pointer">How do I book a trip?</summary>
                    <p className="mt-2 text-sm text-gray-600 leading-relaxed">Simply browse our destinations, select your preferences, and follow the booking process. You'll receive confirmation via email.</p>
                  </details>
                  <details className="border border-gray-200 rounded-xl p-4 bg-white">
                    <summary className="font-medium text-gray-900 cursor-pointer">Can I cancel my booking?</summary>
                    <p className="mt-2 text-sm text-gray-600 leading-relaxed">Yes, you can cancel your booking up to 24 hours before your trip for a full refund.</p>
                  </details>
                  <details className="border border-gray-200 rounded-xl p-4 bg-white">
                    <summary className="font-medium text-gray-900 cursor-pointer">What payment methods do you accept?</summary>
                    <p className="mt-2 text-sm text-gray-600 leading-relaxed">We accept all major credit cards, PayPal, and bank transfers.</p>
                  </details>
                </div>
              </div>
            </div>
        ...
        return {
          ...
          content: (
            <div className="space-y-6 max-h-96 overflow-y-auto pr-2">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-3">6. Revisions and Errata</h3>
                <p className="text-sm text-gray-600 leading-relaxed">
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3 p-4 bg-emerald-50 rounded-xl border border-emerald-100">
                    ...
                    <div>
                      <p className="font-medium text-slate-900">30+ days before trip</p>
                      <p className="text-sm text-gray-600">Full refund (100%)</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 p-4 bg-amber-50 rounded-xl border border-amber-100">
                    <div className="w-10 h-10 bg-amber-500 rounded-xl flex items-center justify-center text-white font-bold">!</div>
                    <div>
                      <p className="font-medium text-slate-900">14-29 days before trip</p>
                  ...
                  <div className="flex items-center gap-3 p-4 bg-red-50 rounded-xl border border-red-100">
                    ...
                    <div>
                      <p className="font-medium text-slate-900">Less than 14 days</p>
