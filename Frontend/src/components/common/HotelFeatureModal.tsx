...
import { X, Hotel, Star, MapPin, Wifi, Car, Coffee, Dumbbell, Check } from 'lucide-react';

interface HotelFeatureModalProps {
  isOpen: boolean;
  onClose: () => void;
  onContinue: () => void;
}

export const HotelFeatureModal: React.FC<HotelFeatureModalProps> = ({ 
  isOpen, 
  onClose, 
  onContinue 
}) => {
