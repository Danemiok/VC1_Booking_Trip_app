...
export const HotelFeatureModal = ({ isOpen, onClose, onContinue }) => {
    ...
    return (<div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full overflow-hidden">
        {/* Header */}
        <div className="relative h-48 bg-gradient-to-br from-emerald-500 to-purple-600">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center text-white">
              ...
              <p className="text-emerald-100 mt-1">Your Perfect Stay Awaits</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-6">
          ...
          <div className="flex gap-3 mt-6">
            ...
            <button onClick={onContinue} className="flex-1 px-4 py-3 bg-emerald-600 text-white rounded-xl hover:bg-emerald-700 transition-colors font-medium flex items-center justify-center gap-2">
              Explore Hotels
